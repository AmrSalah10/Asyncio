...
# async version of process_images
...
# sync version of process_images
# def process_images_sync(orig_paths: list[Path]) -> list[Path]:
#     with ProcessPoolExecutor() as executor:
#         results = list(executor.map(process_single_image, orig_paths))
#     return results
...
async def main():
    ...
    # processed_paths = process_images_sync(img_paths)
